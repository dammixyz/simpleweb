        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-widget widget-user mt-3">
                    ...
                    <div class="widget-user-header text-white" style="background: url('/userbg.jpg') center center;">
                        <h3 class="widget-user-username text-right">{{this.form.name}}</h3>
                        <h5 class="widget-user-desc text-right">{{this.form.email}}</h5>
                    </div>
                    <div class="widget-user-image">
                        <img class="img-circle" :src="loadPic()" alt="User Avatar">
                    </div>
        ...
        methods: {
            ...
            updateProfile(element){
                ...
                if (file['size'] <= 1000000) {
                    ...
                    Toast.fire({
                              icon: 'error',
                              title: 'Image must not be greater than 1MB'
                            })
                }
